...
<div id="services" class="section relative pt-20 pb-8 md:pt-16 md:pb-0 bg-white">
    <div class="container xl:max-w-4xl mx-auto px-4">
        ...
        <form method="POST" action="/register" class="mt-10" novalidate>
            @csrf
            <div class="mb-6">
                ...
                <input class="border border-gray-400 p-2 w-full @error('name') border-red-500 @enderror"
                       type="text"
                       name="name"
                       id="name"
                       value="{{ old('name') }}"
            ...
            <div class="mb-6">
                ...
                <input class="border border-gray-400 p-2 w-full @error('username') border-red-500 @enderror"
                       type="text"
                       name="username"
                       id="username"
                       value="{{ old('username') }}"
